(function attachOfficialData(root) {
  ...
  const users = [
    ...
    { id: "user:seunghyun", playlogId: "sample10", password: "1234", name: "샘플 유저", nickname: "샘플", status: "approved", role: "user", mainPosition: "dm", preferredRole: "활동형 올라운더", profilePreset: "cdm-3", bio: "중원에서 연결과 압박을 함께 가져가는 샘플 플레이어", createdAt: "2026-05-20T08:00:00.000Z", approvedAt: "2026-05-20T08:05:00.000Z", ...testUserFlags },
